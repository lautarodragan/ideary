...
// 3.5.1.1299
// saved at: 2013-12-27 18:27:15
// by: Lautaro Dragan (id: 2006 )
// domain: http://localhost/ideary
...
$shLangTranslateList = array("pt-BR"=>"0","en-GB"=>"0","es-ES"=>"0");
$shLangInsertCodeList = array("pt-BR"=>"0","en-GB"=>"0","es-ES"=>"0");
$defaultComponentStringList = array("cedtag"=>"","banners"=>"","contact"=>"","content"=>"","finder"=>"","joomlaupdate"=>"","login"=>"","mailto"=>"","newsfeeds"=>"","search"=>"","slogin"=>"","taxonomy"=>"","texts"=>"","weblinks"=>"","wrapper"=>"","socialloginandsocialshare"=>"");
$pageTexts = array("pt-BR"=>"Page-%s","en-GB"=>"Page-%s","es-ES"=>"Page-%s");
...
$stopCreatingShurls = '1';
$shurlBlackList = '';
$shurlNonSefBlackList = '';
$includeContentCat = '5';
$includeContentCatCategories = '3';
...
$includeWeblinksCat = '5';
$includeWeblinksCatCategories = '2';
$liveSites = array("pt-BR"=>"","en-GB"=>"","es-ES"=>"");
$alternateTemplate = '';
