 ...
 * @version     $Id: general.php 2340 2012-06-06 14:42:31Z silianacom-svn $
 */
...
class Sh404sefHelperGeneral {
  ...
  public static function getComponentsList( $exclude = array()) {
    ...
    if (is_null($components)) {
      ...
      $exclude = array_merge( array( 'com_sh404sef', 'com_joomfish', 'com_falang','com_joomsef', 'com_acesef', 'com_admin', 'com_cache', 'com_categories', 'com_checkin', 'com_cpanel'
