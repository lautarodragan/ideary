 ...
 * @version     $Id: shSEFConfig.class.php 2354 2012-06-12 18:16:34Z silianacom-svn $
 */
...
unset($shDefaultParamsHelp);
    ...
    $this->content_page_name = empty($this->pageTexts[Sh404sefFactory::getPageInfo()->shMosConfig_locale]) ? 'Page' : str_replace('%s', '', $this->pageTexts[Sh404sefFactory::getPageInfo()->shMosConfig_locale]); // V 1.2.4.r
