 ...
 * @since		1.5
 */
class ContentModelList extends JModelList
{
	/**
	 * Category items data
	 *
    ...
    public function getTextsByCategory($category_id){

        $db = $this->getDbo();
        $query = "SELECT t.*, u.username AS author FROM #__content t ".
            "JOIN #__users u ON (t.created_by=u.id) ".
            "WHERE t.catid=".(int) $category_id;
