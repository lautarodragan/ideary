 ...
 * @version     $Id: shPageRewrite.php 2354 2012-06-12 18:16:34Z silianacom-svn $
 *
 */
...
if (defined('SH404SEF_IS_RUNNING')) {
  ...
  function shDoHeadersChanges() {
    ...
    if (!isset($sefConfig) || empty($sefConfig->shMetaManagementActivated) || empty( $pageInfo->shCurrentPageNonSef)) {
      return;
    }
