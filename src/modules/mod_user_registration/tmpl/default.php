    ...
    $(document).ready(function(){
        ...
        $('#register-form-button').click(function(event){
            ...
            if($(jform_name).val() == ''){
                ...
                $(register_form_error_center).text('Debés ingresar tu nombre.');
            ...
            if($(jform_password1).val().length < 7){
                ...
                var register_form_error_center = $(register_form_input_container).find('.register-form-error-center');
                $(register_form_error_center).text('Debés ingresar más de 6 caracteres.');
                var register_form_error = $(register_form_input_container).find('.register-form-error');
                $(register_form_error).fadeIn('slow');
                success = false;
            }
            ...
            if(success){
                ...
                $.post(check_email_existence_url,
                    ...
                    function(data){
                        if(data.exist){
                            ...
                            var register_form_input_container = $(jform_email1).parents('.register-form-input-container');
                            var register_form_error_center = $(register_form_input_container).find('.register-form-error-center');
                            $(register_form_error_center).text('El correo electrónico ya existe, ingrese otro.');
                            var register_form_error = $(register_form_input_container).find('.register-form-error');
                            $(register_form_error).fadeIn('slow');

                            $(register_form_button).removeClass('disabled');
                        }
                        else{
...
<!--<div id="slogin-buttons" class="slogin-buttons <?php //echo $moduleclass_sfx?>">
    ...
    <form autocomplete="off" id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate">

    <div class="register-form-input-container" style="margin-top: 28px; " >
        <input autocomplete="off" type="text" name="jform[name]" id="jform_name" value="" onblur="setusername(this.value);" class="required register-form-input" size="30" aria-required="true" required="required" placeholder="<?php echo JText::_('ENTER_FIRST_AND_LAST_NAME') ?>">
    ...
    <div style="display:none;">
        <input autocomplete="off" type="text" name="jform[username]" id="jform_username" value="" class="required register-form-input" size="30" aria-required="true" required="required" placeholder="<?php //echo JText::_('ENTER_USERNAME') ?>">
    </div>

    <div class="register-form-input-container" style="margin-top: 18px; " >
        <input autocomplete="off" type="text" name="jform[email1]" class="validate-email required register-form-input" id="jform_email1" value="" size="30" aria-required="true" required="required" placeholder="<?php echo JText::_('ENTER_EMAIL_ADDRESS') ?>">
        <div class="register-form-error">
            <div class="register-form-error-left"></div>
            <div class="register-form-error-center"></div>
            <div class="register-form-error-right"></div>
    ...
    <div class="register-form-input-container">
        <input autocomplete="off" type="text" name="jform[email2]" class="validate-email required register-form-input" id="jform_email2" value="" size="30" aria-required="true" required="required" aria-invalid="true" placeholder="<?php echo JText::_('CONFIRM_EMAIL') ?>">
        <div class="register-form-error">
            <div class="register-form-error-left"></div>
            <div class="register-form-error-center"></div>
            <div class="register-form-error-right"></div>
    ...
    <div class="register-form-input-container" style="margin-top: 18px; " >
        <input autocomplete="off" type="password" name="jform[password1]" id="jform_password1" value="" autocomplete="off" class="validate-password required register-form-input" size="30" aria-required="true" required="required" placeholder="<?php echo JText::_('CREATE_STRONG_PASSWORD') ?>">
        <div class="register-form-error">
            <div class="register-form-error-left"></div>
            <div class="register-form-error-center"></div>
            <div class="register-form-error-right"></div>
    ...
    <div class="register-form-input-container">
        <input autocomplete="off" type="password" name="jform[password2]" id="jform_password2" value="" autocomplete="off" class="validate-password required register-form-input" size="30" aria-required="true" required="required" placeholder="<?php echo JText::_('CONFIRM_PASSWORD') ?>">
        <div class="register-form-error">
            <div class="register-form-error-left"></div>
            <div class="register-form-error-center"></div>
            <div class="register-form-error-right"></div>
